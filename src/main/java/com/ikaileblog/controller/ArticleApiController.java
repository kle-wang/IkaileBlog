...
public class ArticleApiController {
    ...
    public RestBean<List<ArticleVo>> getArticleByCategory(@RequestBody CategoryPageParams categoryPageParams) {
        return articleService.listArticleByCategoryId(categoryPageParams);
    }
}
